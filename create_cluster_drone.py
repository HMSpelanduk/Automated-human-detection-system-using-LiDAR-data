...
# ----------- Settings -----------
PLY_FILE = "data/test data/final_test_4.ply"  # full scene
OUTPUT_DIR = "clusters_data"               # where cluster_*.ply will be saved

# Preprocessing
VOXEL_SIZE = 0.01 #for drone (0.02~0.04)/for realsense (0.0008~0.01)
PLANE_DIST_THRESH = 0.005 #for drone (0.015~0.02)/for realsense (0.004~0.006)
...
# DBSCAN
DBSCAN_EPS = 0.03 #for drone (0.06~0.2)/for realsense (0.023~0.035) // if mannequin and background mix, decrease value
DBSCAN_MIN_SAMPLES = 40 #for drone (10~20)/for realsense (40~60)
MIN_POINTS_IN_CLUSTER = 150 #original value 150

# Cluster merging
ENABLE_CLUSTER_MERGE = False
MERGE_DIST = 0.08 #for drone (0.20~0.40)/for realsense (0.08~0.12) // if mannequin breaks into many parts, increase
